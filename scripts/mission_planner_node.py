...
if __name__ == '__main__':
    ...
    parser.add_argument('base_pose_topic_name', type=str, help='Topic name for the base pose.')
    ...
    mission_planner = MissionPlanner(args.config_file_path, args.goal_topic_name, args.base_pose_topic_name)
