...
import argparse
from smb_mission_planner.utils.mission_recorder import MissionRecorder
...
if __name__ == '__main__':
    ...
    mission_recorder = MissionRecorder(args.config_file_path, args.waypoint_topic_name, args.base_pose_topic_name)
