...
def createMissionPlan(missions_data):
    ...
    with state_machine:
        smach.StateMachine.add('Mission 1', mission_planner.Mission(missions_data['mission_1']),
        transitions={'Completed':'Mission 2', 'Aborted':'Failure', 'Next Goal':'Mission 1'})

        smach.StateMachine.add('Mission 2', mission_planner.Mission(missions_data['mission_2']),
        transitions={'Completed':'Success', 'Aborted':'Mission 3', 'Next Goal':'Mission 2'})

        smach.StateMachine.add('Mission 3', mission_planner.Mission(missions_data['mission_3']),
